...
def main():
    ...
    parser.add_argument('-t', "--trainset", action='store', default="../dataset/balancedtest.csv", help=('Path to csv file '"[default: %(default)s]"))
    parser.add_argument('-o', "--output", action='store', default='../dataset/result_extraction_punctuation.csv', help=('Path to csv file '"[default: %(default)s]"))
