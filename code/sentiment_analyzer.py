...
class SentimentExtractor : 
	""" Count the number of good and bad words in each article, based on an annoted dataset
		return a csv file with the positive, negative and neutral frequencies per article """
